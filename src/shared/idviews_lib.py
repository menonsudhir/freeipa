...
def idview_add(host, viewname, desc=None, set_attr=None, addattr=None, alloption=None, raw=None, allraw=None):
    """Adding views """
...
def idoverrideuser_add(host, viewname, user=None, uid=None, gid=None, desc=None, login=None, gecos=None, shell=None,
...
def idoverrideuser_mod(host, viewname, user=None, uid=None, gid=None, desc=None, login=None, gecos=None, shell=None,
                       key=None, homedir=None):
