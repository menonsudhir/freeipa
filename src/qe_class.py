...
class QeConfig(pytest_multihost.config.Config):
    ...
    def __init__(self, **kwargs):
        ...
        self.ad_top_domain = kwargs.get('ad_top_domain', 'ipaad2016ci.test')
        self.ad_sub_domain = kwargs.get('ad_sub_domain', 'ipasubad2016ci.ipaad2016ci.test')
        self.ad_ip = kwargs.get('ad_ip', '10.8.253.86')
        self.ad_subip = kwargs.get('ad_subip', '10.8.247.142')
        self.ad_user = kwargs.get('ad_user', 'Administrator')
        self.ad_pwd = kwargs.get('ad_pwd', 'Secret123')
        self.ad_hostname = kwargs.get('ad_hostname', 'ipaad2016.ipaad2016ci.test')
        self.ad_sub_hostname = kwargs.get('ad_sub_hostname', 'ipasubd.ipasubad2016ci.ipaad2016ci.test')
