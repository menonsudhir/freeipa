...
class QeConfig(pytest_multihost.config.Config):
    ...
    def __init__(self, **kwargs):
        ...
        self.ad_top_domain = kwargs.get('ad_top_domain', 'ipaad2k16cin.test')
        self.ad_sub_domain = kwargs.get('ad_sub_domain', 'ipasubad2k16cin.ipaad2k16cin.test')
        self.ad_ip = kwargs.get('ad_ip', '10.0.144.176')
        self.ad_subip = kwargs.get('ad_subip', '10.0.144.244')
        self.ad_user = kwargs.get('ad_user', 'Administrator')
        self.ad_pwd = kwargs.get('ad_pwd', 'Secret123')
        self.ad_hostname = kwargs.get('ad_hostname', 'ipaad2k16ci.ipaad2k16cin.test')
        self.ad_sub_hostname = kwargs.get('ad_sub_hostname', 'permanent-ipaad.ipasubad2k16cin.ipaad2k16cin.test')
        ...
        self.client_stream = kwargs.get('client_module', 'idm:client')
