...
class Testmaster(object):
    ...
    def test_0009_bz1183116(self, multihost):
        """
        This testcase checks if ipa-server have dependency
        on subscription-manager
        Automation for #bz1183116
        """
        cmdstr = '%s -qR ipa-server | grep subscription-manager' % paths.RPM
        multihost.master.qerun(cmdstr, exp_returncode=0)

    def test_0010_bz1324060(self, multihost):
        """
        test_0010_bz1324060
